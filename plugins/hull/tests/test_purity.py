...
1. The pure rule-engine modules (scanners, config, plan, render, scaffold)
...
PURE_MODULES = ("scanners", "config", "plan", "render", "scaffold")
...
def test_pure_modules_list_covers_every_module_in_the_package():
    ...
    """
    on_disk = {p.stem for p in HULL_PKG.glob("*.py")} - {"__init__"}
