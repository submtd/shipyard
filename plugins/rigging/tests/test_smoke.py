...
skill frontmatter, an end-to-end render, and a systemic layout guard.
"""
...
def test_package_imports():
    ...
    assert rigging.__version__ == "0.5.1"
...
def test_end_to_end_render_from_fixture_config(tmp_path):
    ...
    text = render(build_plan(load_config(tmp_path)))
    assert text
...
def test_no_plugin_tests_dir_is_a_package():
    ...
    stay a plain, unpackaged directory.
    """
