...
1. The pure rule-engine modules (ecosystems, config, detect, plan, render,
...
PURE_MODULES = ("ecosystems", "config", "detect", "plan", "render", "scaffold")
...
def test_pure_modules_list_covers_every_module_in_the_package():
    ...
    """
    on_disk = {p.stem for p in BOSUN_PKG.glob("*.py")} - {"__init__"}
